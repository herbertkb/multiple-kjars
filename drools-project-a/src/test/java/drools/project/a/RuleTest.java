...
package drools.project.a;

import static org.junit.Assert.*;

import drools.project.b.Dog;
...
public class RuleTest {
	...
	LOG.info("Inserting for Project B");
        ...
        assertEquals("Size of object in Working Memory is 2", 2, session.getObjects().size());
        assertTrue("contains red", check.contains("red"));
        assertTrue("contains poodle", check.contains("poodle"));
